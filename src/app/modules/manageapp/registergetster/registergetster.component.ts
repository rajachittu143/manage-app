...
export class RegistergetsterComponent implements OnInit {
  ...
  errorMsg = '';
  hide: any;
  registerGetsterForm1!: FormGroup;
  ...
  ngOnInit(): void {
    this.registerGetsterForm1 = new FormGroup({
  ...
  onNextReg() {
    let fname = this.registerGetsterForm1.value.firstname;
    let lname = this.registerGetsterForm1.value.lastname;
    this.router.navigate(['/manage-app/register-face',{ firstName:fname, lastName:lname}])
      .then(() => {
